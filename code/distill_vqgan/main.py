...
def get_distillation_model(ckpt_path):
...
def get_model_and_dataloader(batch_size):
    fmri_model_config = vqmodel_config
    fmri_model_loss_config = distilla_fmri_loss_config
    fmri_vq_model_ckpt_path = "pretrains/ldm/label2img/model.ckpt"
    fmri_vit_ckpt_path = "pretrains/BOLD5000/fmri_encoder.pth"
    ...
    num_voxels = fmri_encoder.patch_embed.num_voxels
    train_dataset, test_dataset = create_BOLD5000_dataset(subjects=['CSI4'],
...
if __name__ == "__main__":
    ...
    try:
        ...
        model, train_dataloader, test_dataloader = get_model_and_dataloader(batch_size)
        ...
        default_modelckpt_cfg["params"]["monitor"] = "val_ema/rec_loss"
